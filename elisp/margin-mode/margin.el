...
(defgroup margin nil
  "Add a right-hand margin for rows exceeding length specified by
margin-column"
  :version "21.2"
  :group 'tools)

(defcustom margin-column 72
...
(defun margin-custom-set (symbol value)
  "Set value of the variable SYMBOL to VALUE and update overlay
categories. Used in :set parameter of some customized glasses
variables."
