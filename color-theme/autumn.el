(defun color-theme-autumn ()
  ...
  (color-theme-install
   '(color-theme-autumn
     ...
     (custom-state-face ((t (:foreground "beige"))))
     (custom-variable-button-face ((t (:bold t :underline t :family "fixed" :weight bold))))
     (custom-variable-tag-face ((t (:bold t :foreground "Khaki"))))
     ...
     (diff-added ((t (:foreground "color-40"))))
     (diff-removed ((t (:foreground "orange"))))
     (diff-indicator-added ((t (:foreground "color-40"))))
     ...
     (erc-default-face ((t (:foreground "beige"))))
     ...
     (erc-notice-face ((t (:foreground "khaki"))))
     (erc-pal-face ((t (:foreground "burlywood"))))
     (erc-prompt-face ((t (:foreground "orange"))))
     (erc-timestamp-face ((t (:bold t :foreground "burlywood"))))
     ...
     (font-lock-face ((t (:foreground "peru"))))
     ...
     (font-lock-type-face ((t (:foreground "khaki"))))
     (font-lock-variable-name-face ((t (:foreground "beige"))))
     (font-lock-warning-face ((t (:bold t :foreground "red"))))
     (fringe ((t (:background "color-82"))))
     ...
     (header-line ((t (:box (:line-width -1 :style released-button) :background "color-82" :foreground "beige" :box nil))))
     (highlight ((t (:background "color-37" :foreground "beige"))))
     ...
     (mode-line ((t (:background "gray40" :foreground "beige" :box (:line-width 1 :style nil)))))
     (mode-line-inactive ((t (:background "gray25" :foreground "beige" :box (:line-width 1 :style nil)))))
     (modeline-buffer-id ((t (:background "gray40" :foreground "beige"))))
     ...
     (tla-added ((t (:foreground "color-40"))))
     (tla-archive-name ((t (:foreground "orange"))))
