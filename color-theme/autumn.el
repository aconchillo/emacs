(defun color-theme-autumn ()
  ...
  (color-theme-install
   '(color-theme-autumn
     ...
     (fringe ((t (:background "color-82")))) (gnus-button ((t (:bold t :weight bold :foreground "LightSalmon"))))
     (gnus-cite-attribution-face ((t (:italic t :slant italic))))
     (gnus-cite-1 ((t (:foreground "LightSalmon"))))
     (gnus-cite-2 ((t (:foreground "burlywood"))))
     (gnus-cite-3 ((t (:foreground "dark khaki"))))
     (gnus-cite-4 ((t (:foreground "lightsalmon"))))
     (gnus-cite-5 ((t (:foreground "dark khaki"))))
     (gnus-cite-6 ((t (:foreground "bisque"))))
     (gnus-cite-7 ((t (:foreground "peru"))))
     (gnus-cite-8 ((t (:foreground "light salmon"))))
     ...
     (gnus-group-mail-1 ((t (:bold t :foreground "burlywood" :weight bold))))
     (gnus-group-mail-1-empty ((t (:foreground "antiquewhite4"))))
     (gnus-group-mail-2 ((t (:bold t :foreground "burlywood" :weight bold))))
     (gnus-group-mail-2-empty ((t (:foreground "antiquewhite4"))))
     (gnus-group-mail-3 ((t (:bold t :foreground "burlywood" :weight bold))))
     (gnus-group-mail-3-empty ((t (:foreground "antiquewhite4"))))
     (gnus-group-mail-low ((t (:bold t :foreground "grey" :weight bold))))
     (gnus-group-mail-low-empty ((t (:foreground "grey"))))
     (gnus-group-news-1 ((t (:inherit gnus-group-mail-1))))
     (gnus-group-news-1-empty ((t (:inherit gnus-group-mail-1-empty))))
     (gnus-group-news-2 ((t (:inherit gnus-group-mail-2))))
     (gnus-group-news-2-empty ((t (:inherit gnus-group-mail-2-empty))))
     (gnus-group-news-3 ((t (:inherit gnus-group-mail-3))))
     (gnus-group-news-3-empty ((t (:inherit gnus-group-mail-3-empty))))
     (gnus-group-news-low ((t (:bold t :foreground "burlywood4" :weight bold))))
     (gnus-group-news-low-empty ((t (:foreground "burlywood4"))))
     (gnus-header-content ((t (:foreground "burlywood3"))))
     (gnus-header-from ((t (:foreground "burlywood2"))))
     (gnus-header-name ((t (:foreground "burlywood4"))))
     (gnus-header-newsgroups ((t (:bold t :foreground "khaki" :weight bold))))
     (gnus-header-subject ((t (:bold t :foreground "burlywood" :weight bold))))
     ...
     (gnus-signature ((t (:italic t :foreground "Grey" :slant italic))))
     (gnus-splash ((t (:foreground "ForestGreen"))))
     (gnus-summary-cancelled ((t (:background "Black" :foreground "GoldenRod"))))
     ...
     (gnus-summary-low-read ((t (:italic t :foreground "slate gray" :slant italic))))
     (gnus-summary-low-ticked ((t (:italic t :foreground "burlywood" :slant italic))))
     (gnus-summary-low-undownloaded ((t (:italic t :foreground "LightGray" :slant italic :weight normal))))
     (gnus-summary-low-unread ((t (:italic t :foreground "LightGray" :slant italic))))
     (gnus-summary-normal-ancient ((t (:foreground "burlywood"))))
     (gnus-summary-normal-read ((t (:foreground "DarkOliveGreen"))))
     (gnus-summary-normal-ticked ((t (:foreground "IndianRed"))))
     (gnus-summary-normal-undownloaded ((t (:foreground "LightGray" :weight normal))))
     (gnus-summary-normal-unread ((t (nil))))
     (gnus-summary-selected ((t (:foreground "LightSalmon" :underline t))))
     ...
     (org-todo ((t (:bold t :foreground "IndianRed"))))
     (org-warning ((t (:bold t :foreground "IndianRed"))))
     ...
     (quack-pltish-paren-face ((t (:foreground "bisque"))))
